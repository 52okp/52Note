...
type Appearance struct {
	...
	CloseButtonBehaviorVersion int                 `json:"closeButtonBehaviorVersion"` // 关闭按钮行为配置版本
...
func NewAppearance() *Appearance {
	return &Appearance{
		...
		CloseButtonBehaviorVersion: CloseButtonBehaviorVersion,
		HideToolbar:                true,
		HideStatusBar:              false,
...
const (
	CloseButtonBehaviorVersion   = 1
	EntryVisibilityVersion       = 3
	EntryVisibilityProfileSimple = "simple"
	EntryVisibilityProfileFull   = "full"
)

func NormalizeCloseButtonBehavior(appearance *Appearance, versionConfigured bool) {
	if !versionConfigured || appearance.CloseButtonBehaviorVersion < CloseButtonBehaviorVersion {
		appearance.CloseButtonBehavior = 1
	}
	appearance.CloseButtonBehaviorVersion = CloseButtonBehaviorVersion
}
