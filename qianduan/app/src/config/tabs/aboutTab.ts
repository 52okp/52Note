...
const genAboutVersionHtml = (): string => {
    ...
    <div class="fn__flex-1">
        <div class="config-name">${window.siyuan.languages.currentVer} v${Constants.SIYUAN_VERSION}</div>
        <div class="b3-label__text"><a href="https://github.com/52okp/52Note/releases" target="_blank" rel="noopener noreferrer">GitHub Releases</a></div>
    </div>
...
const registerAboutInfoGroup = (tab: SettingTabBuilder) => {
    ...
    <div class="fn__flex-1">
        ...
        <div class="fn__flex fn__flex-wrap" style="gap: 8px 16px">
            ...
            <a href="https://github.com/52okp/52Note/blob/master/THIRD_PARTY_NOTICES.md" target="_blank" rel="noopener noreferrer">THIRD_PARTY_NOTICES</a>
        </div>
    </div>
    <div class="fn__space"></div>
    <div class="fn__flex-center fn__size200">
        <button id="sponsorBtn" class="b3-button b3-button--pink fn__block" disabled aria-disabled="true">
