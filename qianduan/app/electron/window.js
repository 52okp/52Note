...
const I18N_BASE = {
    "zh-CN": {
        ...
        community: "用户社区汇总",
        download: "下载最新版",
        feedbackUrl: "https://github.com/52okp/52Note/issues",
        communityUrl: "https://github.com/52okp/52Note/discussions",
        downloadUrl: "https://github.com/52okp/52Note/releases",
...
const chooseWorkspacePath = async (langData) => {
    ...
    let defaultWorkspace = path.join(decodeURIComponent(getSearch("home")), "52Note");
    if ("darwin" === process.platform) {
        // Change the initial workspace path to ~/Library/Application Support/52Note on macOS.
        defaultWorkspace = path.join(decodeURIComponent(getSearch("home")), "Library", "Application Support", "52Note");
    }
